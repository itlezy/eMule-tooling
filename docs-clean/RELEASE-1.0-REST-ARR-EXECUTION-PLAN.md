...
| `CI-014` | In Progress | `3bc65d6`, `3101391` tests; `89810c5` tooling | REST smoke consumes OpenAPI body metadata and OpenAPI documents explicit confirmation bodies. Native route specs now fail against OpenAPI method/path drift. Request/response field drift checks and live evidence remain open. |
