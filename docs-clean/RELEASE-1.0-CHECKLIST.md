...
| [CI-011](CI-011.md) | Release live E2E umbrella | In Progress | tests: `13f1487` focused long-path shared-directory proof | `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64`; focused proof: `pwsh -File repos\eMule-build\workspace.ps1 live-e2e -Config Release -Platform x64 -LiveSuite shared-directories-rest` | Full umbrella still requires `repos\eMule-build-tests\reports\live-e2e-suite-latest\result.json`; focused proof passed in `repos\eMule-build-tests\reports\shared-directories-rest\20260506-202103-eMule-main-release\result.json` with a 325-character Unicode shared root, shared-file listing, persistence, and relaunch reload | Blocks tag |
